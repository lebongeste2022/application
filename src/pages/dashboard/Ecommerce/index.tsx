...
const EcommerceDashboard = () => {
    ...
    return (
        <>
                                    ...
                                    <Col md={'auto'}>
                                        <Dropdown as={ButtonGroup} align="end">
                                            <Dropdown.Toggle
                                                ...
                                                <i className="uil uil-file-alt me-1"></i>Télécharger
                                                <i className="icon">
            ...
            <Row>
                <Col xl={4}>
                    <MembersList title={'Top '} members={topPerformers} />
                </Col>
                <Col xl={4}>
                    <Tasks tasks={tasks} />
                </Col>
                <Col xl={4}>
                    <ChatList title="Conversation recentes" messages={chatMessages} />
                </Col>
            </Row>
        </>
    );
