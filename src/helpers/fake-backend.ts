...
export function configureFakeBackend() {
    let users: UserData[] = [
        ...
        {
            id: 2,
            email: 'yveslalanne.diplomatie@outlook.fr',
            username: 'test',
            password: 'test',
            firstName: 'Test',
            lastName: 'User',
    ...
    mock.onPost('/login/').reply(function (config) {
        return new Promise(function (resolve, reject) {
            setTimeout(function () {
                ...
                // find if any user matches  credentials
                ...
                if (filteredUsers.length) {
                    ...
                    // else return error
                    resolve([401, { message: 'identifiant ou mot de passe est incorrect' }]);
                }
            }, 1000);
        });
    });
        ...
        return new Promise(function (resolve, reject) {
            setTimeout(function () {
                ...
                if (filteredUsers.length) {
                    // if login details are valid return user details and fake jwt token
                    let responseJson = {
                        message: "Nous vous avons envoyé un lien pour réinitialiser le mot de passe à votre adresse e-mail enregistrée.",
                    };
                    ...
                    resolve([
                        401,
                        {
                            message: 'Désolé, nous n avons trouvé aucun utilisateur enregistré avec le nom d utilisateur saisi',
                        },
                    ]);
                }
            }, 1000);
