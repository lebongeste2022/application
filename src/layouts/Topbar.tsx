...
const Notifications: NotificationItem[] = [
    {
        id: 1,
        text: 'Cristina Pride',
        subText: 'Salut comment ca va? Et notre prochaine rencontre',
        avatar: profilePic,
    },
    {
        id: 2,
        text: 'Caleb Flakelar a commenté sur Admin',
        subText: '1 min ago',
    ...
    },
    {
        id: 3,
        text: 'Karen Robinson',
        subText: 'Wow ! cet administrateur a l’air bien et son design est génial',
        avatar: avatar4,
    },
    {
        id: 4,
    ...
    },
    {
        id: 5,
        text: 'Caleb Flakelar a commenté sur Admin',
        subText: 'il y a 1 min ',
        icon: 'uil uil-comment-message',
        bgColor: 'info',
    },
    {
        id: 6,
        text: 'Carlos Crouch a liker Admin',
        subText: 'Il y a 13 jours',
        icon: 'uil uil-heart',
        bgColor: 'secondary',
    },
];
...
const otherOptions = [
    ...
    {
        id: 2,
        label: 'Creer nouveau Utilisateur',
        icon: 'uil uil-user-plus',
    },
    {
        id: 3,
        label: 'Rapport sur les revenus',
