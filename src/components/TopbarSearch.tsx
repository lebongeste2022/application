    ...
    return (
        <components.MenuList {...props}>
            ...
            <div className="dropdown-header noti-title">
                <h5 className="text-overflow mb-2"> {options.length} resultas trouvés</h5>
            </div>
            {props.children}
        </components.MenuList>
    );
...
const TopbarSearch = (props: TopbarSearchProps) => {
    const options: SearchOptions[] = [
        { value: '1', label: 'Paramètres du profil utilisateur', icon: 'uil uil-sliders-v-alt', type: 'settings' },
        { value: '2', label: 'Rapport d analyse', icon: 'uil uil-home-alt', type: 'report' },
        { value: '3', label: 'Comment puis-je vous aider ?', icon: 'uil uil-life-ring', type: 'help' },
        {
            ...
            userDetails: {
                firstname: 'Shirley',
                lastname: 'Miller',
                position: 'Concepteur d interface utilisateur',
                avatar: Avatar2,
            },
        },
        {
